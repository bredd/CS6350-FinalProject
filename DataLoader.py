...
class DataLoader:
    ...
    def LoadKaggleTrain(limit=None, overrideCol=None, overrideVal=None):
        ...
        ds.PartitionColumn(0, "Age", overrideVal if overrideCol == 0 else 10)
        ...
        ds.CategorizeColumn(3, "Marital", overrideVal if overrideCol == 3 else 0.05)
        ds.CategorizeColumn(4, "Occupation", overrideVal if overrideCol == 4 else 0.08)
        ds.CategorizeColumn(5, "Relationship", overrideVal if overrideCol == 5 else 0.05)
        ds.CategorizeColumn(6, "Race", overrideVal if overrideCol == 6 else 0.05)
        ...
        ds.PartitionColumn(9, "HoursPerWeek", overrideVal if overrideCol == 9 else 8)
        ds.CategorizeColumn(10, "NativeCountry", overrideVal if overrideCol == 10 else 0.0008)
